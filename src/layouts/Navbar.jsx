...
export default function Navbar() {
  ...
  const signupButton = () => {
    return (
      <button
        onClick={connect}
        className="my-2 mb-2 inline-flex items-center justify-center rounded-lg bg-[#24292F] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#24292F]/90 focus:outline-none focus:ring-4 focus:ring-[#24292F]/50 dark:hover:bg-[#050708]/30 dark:focus:ring-gray-500"
      >
        <svg
          aria-hidden="true"
          class="mr-2 -ml-1 h-5 w-6"
  ...
  const signoutButton = () => {
    return (
      <button
        onClick={disconnect}
        className="my-2 mr-2 mb-2 inline-flex items-center justify-center rounded-lg bg-[#24292F] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#24292F]/90 focus:outline-none focus:ring-4 focus:ring-[#24292F]/50 dark:hover:bg-[#050708]/30 dark:focus:ring-gray-500"
      >
        Sign out
      </button>
    );
          ...
          <Container maxWidth="lg">
            <Toolbar disableGutters>
              ...
              <Box
                ...
                gap={1}
              >
                <div>{currentAccount ? displayAddress() : signupButton()}</div>
                <div>{currentAccount ? signoutButton() : null}</div>
              </Box>
            </Toolbar>
          </Container>
        </div>
